                      ...
                      <div className="col-12">
                        <div className="form-wrap-admin">
                          <form>
                            ...
                            <div class="form-group row">
                              <label for="staticEmail" class="col-sm-2 col-form-label">Store logo</label>
                              <div class="col-sm-10">
                                <input class="form-control" type="text" />
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              <label for="staticEmail" class="col-sm-2 col-form-label">Store email</label>
                              <div class="col-sm-10">
                                <input class="form-control" type="text" />
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              <label for="staticEmail" class="col-sm-2 col-form-label">Store phone</label>
                              <div class="col-sm-10">
                                <input class="form-control" type="text" />
                              </div>
                            </div>
                            ...
                            <div class="form-group row">
                              <label for="staticEmail" class="col-sm-2 col-form-label">Store Address</label>
                              <div class="col-sm-10">
                      ...
                      <div className="col-12">
                        <div className="form-wrap-admin">
                          <form>
                            ...
                            <div class="form-group row">
                              <label for="staticEmail" class="col-sm-2 col-form-label">Discord</label>
                              <div class="col-sm-10">
                                <input class="form-control" type="text" />
                              </div>
                            </div>
